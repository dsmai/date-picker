...
const DateBox = () => {
    ...
    return ( 
        <>
          ...
          <input type="number" className="number-input" value={number} onChange={handleNumberChange}/>
          <input type="text" className="text-input" value={note.content} placeholder="Take a note..." onChange={handleNoteChange}/>
          <button className="data-reset" onClick={handleReset}>Reset all</button>
